...
urlpatterns = [
    ...
    path(
        "programmes/<int:pk>/edit/",
        views.programme_update_view,
        name="programme_update",
    ),
    path(
        "programmes/<int:pk>/delete/",
        views.programme_delete_view,
        name="programme_delete",
    ),
    # Financial Transaction URLs
    path(
        "finances/",
        views.financial_transaction_list_view,
        name="financial_transaction_list",
    ),
    path(
        "finances/add/",
        views.financial_transaction_create_view,
        name="financial_transaction_create",
    ),
    path(
        "finances/<int:pk>/",
        views.financial_transaction_detail_view,
        name="financial_transaction_detail",
    ),
    path(
        "finances/<int:pk>/edit/",
        views.financial_transaction_update_view,
        name="financial_transaction_update",
    ),
    path(
        "finances/<int:pk>/delete/",
        views.financial_transaction_delete_view,
        name="financial_transaction_delete",
    ),
    # To-Do List URLs
    ...
    path(
        "commercials/<int:pk>/", views.commercial_detail_view, name="commercial_detail"
    ),
    path(
        "commercials/<int:pk>/edit/",
        views.commercial_update_view,
        name="commercial_update",
    ),
    path(
        "commercials/<int:pk>/delete/",
        views.commercial_delete_view,
